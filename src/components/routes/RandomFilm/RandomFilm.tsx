...
export default function RandomFilm() {
  ...
  useEffect(() => {}, [...Object.keys(model).map((key) => model[key])]);
      ...
      <div className='filter-container rounded-border-1'>
        <div className='filter-inner'>
          <div className='filter-item'>
            <div className='text-white form-label text-bold'>
              Год ({model.year[0]}-{model.year[1]})
            </div>
            <div
              style={{ borderBottom: '2px solid white', position: 'relative', top: '30px' }}
            ></div>
            <Slider
              min={1874}
              defaultValue={[1874, 2024]}
          ...
          <div className='filter-item'>
            <div className='text-white form-label text-bold '>
              Рейтинг Кинопоиска ({model.kpRating[0]}-{model.kpRating[1]})
            </div>
            <div
              style={{ borderBottom: '2px solid white', position: 'relative', top: '30px' }}
            ></div>
